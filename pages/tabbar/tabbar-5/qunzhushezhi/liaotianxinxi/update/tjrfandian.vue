	...
	export default{
		...
		methods:{
			...
			handleSave(){
				...
				this.$http.httpPostToken('/crowd/updateReferrerRebate',{
					crowdId:this.crowdId,
					referrerRebate: Number(this.valueStr.trim())/100,
				},(res)=>{
					uni.hideKeyboard()
					uni.navigateBack({});
					uni.$emit("updateReferrerRebate",Number(this.valueStr.trim())/100)
				},true)
			}
		}
	}
